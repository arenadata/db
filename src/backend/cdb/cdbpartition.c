			...
			foreach(lc3, colvals)
			{
				...
				else
				{
					...
					if (!ls->eqinit[i])
					{
						...
						/*
						 * Type of rule is in fact the type of const in rule.
 ...
 * values is an array of datums containing the input key, isnull tells us which
 * of those is NULL, tupdesc specifies types of values in values and isnull.
